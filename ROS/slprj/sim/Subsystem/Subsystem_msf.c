...
#define S_FUNCTION_NAME Subsystem_msf
#endif
...
MdlRefChildMdlRec childModels [ 1 ] = { "Subsystem" , "Subsystem" , 0 } ;
...
) ) return ; if ( ! ssSetOutputPortMatrixDimensions ( S , 0 , 320 , 1280 ) )
...
mr_Subsystem_RegisterSimStateChecksum ( S ) ; { static ssRTWStorageType
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\" pr=\"d\"><arguments><arg type=\"encoded\">UwB1AGIAcwB5AHMAdABlAG0ALwBDAG8AbABvAHIAIABTAHAAYQBjAGUAIAAgAEMAbwBuAHYAZQByAHMAaQBvAG4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAIABMnkD+</h></hs></diag></diag_root>"
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_Subsystem_MdlInfoRegFcn
( S , "Subsystem" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( lv5k3yfyktq ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { lv5k3yfyktq * dw = (
lv5k3yfyktq * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } ffkf2sfekd
...
mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { lv5k3yfyktq * dw = ( lv5k3yfyktq * )
ssGetDWork ( S , 0 ) ; er2wgkaxlg ( & ( dw -> rtdw ) ) ; } static void
mdlOutputs ( SimStruct * S , int_T tid ) { lv5k3yfyktq * dw = ( lv5k3yfyktq *
...
PARAMETER_TUNING_TID ) { Subsystem ( i_ROOT_U0 , o_ROOT_Y0 , & ( dw -> rtb )
, & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct * S ) {
lv5k3yfyktq * dw = ( lv5k3yfyktq * ) ssGetDWork ( S , 0 ) ; cjev2n2srg ( & (
dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_Subsystem_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_Subsystem_GetSimStateDisallowedBlocks ( ) ;
...
mr_Subsystem_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
